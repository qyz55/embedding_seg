...
values = [
    ini_learning_rate, ini_learning_rate * 0.1, ini_learning_rate,
    ini_learning_rate * 0.1, ini_learning_rate, ini_learning_rate * 0.1
]

# Define Dataset
train_file = 'train_parent.txt'
dataset = Dataset(
    train_file, None, './DAVIS', store_memory=store_memory, data_aug=data_aug)
